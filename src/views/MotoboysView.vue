<template>
  ...
  <div class="card card-adc col-4 d-flex justify-content-center align-items-center p-4 float-start">
    ...
    <form @submit.prevent="adicionarMotoboy">
      <fieldset>
        ...
        <button @click="adicionarMotoboy(motoboy.id)" class="btn btn-danger btn-sm">
          Adicionar Motoboy
        </button>
      </fieldset>
    </form>
  ...
  <div
    class="card card-motoboys col-4 d-flex justify-content-center align-items-center p-4 float-start"
  >
    ...
    <table class="table mt-4">
      ...
      <tbody>
        <tr v-for="motoboy in motoboys" :key="motoboy.id">
          ...
          <td>{{ motoboy.email }}</td>
          <td>
            <button @click="excluirMotoboy(motoboy.id)" class="btn btn-danger btn-sm">
              Excluir
            </button>
          </td>
        </tr>
